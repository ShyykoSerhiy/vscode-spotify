...
<div class="img-wrapper">
    <img
      id="trackArtwork"
      class={isHoveringControls ? 'trackArtwork-darkened' : "trackArtwork"}
      src={track.artwork_url}
      alt='Wrapper view for the album.'
    />
      ...
      <section class="controller">
        <div class="shuffle-repeat-btn">
          <button
            class="shuffle"
            on:click={() =>
              triggerSpotifyCommand("spotify.toggleShuffling")}
          >
            <img src={ShuffleIcon} class="icons"
            alt='shuffle icon' />
          </button>
        ...
        <button
          class="prevBtn"
          on:click={() => triggerSpotifyCommand("spotify.previous")}
        >
          <img src={PreviousIcon} class="icons"
          alt='Previous icon button.' />
        </button>
        <button
        class="pausePlay"
        on:click={() => triggerSpotifyCommand("spotify.playPause")}
        >
        {#if pauseOrPlay === 'pause'}
          <img src={PauseIcon} id="pausePlayIcon" class="icons"
          alt='Pause or play icon button.' />
          {:else}
          <img src={PlayIcon} id="pausePlayIcon" class="icons"
          alt='Pause or play icon button.' />
        {/if}
        ...
        <button
          class="nextBtn"
          on:click={() => triggerSpotifyCommand("spotify.next")}
        >
          <img src={NextIcon} class="icons"
          alt='Next icon button.' />
        </button>
        <div
          class="shuffle-repeat-btn"
          on:click={() =>
           triggerSpotifyCommand("spotify.toggleRepeating")}
        >
          <button class="repeat">
            <img src={RepeatIcon} class="icons"
            alt='Shuffle icon button.' />
          </button>
